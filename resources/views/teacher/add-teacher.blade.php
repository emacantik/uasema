    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Tambahkan Pengajar</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="teachers.html">Halaman</a></li>
                    ...
                    <div class="card-body">
                        <form action="{{ route('teacher/save') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>ID Pengajar <span class="login-danger">*</span></label>
                                        <input type="text" class="form-control" name="teacher_id" id="teacher_id" placeholder="ID Pengajar" value="{{ old('teacher_id') }}" readonly>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input class="form-control @error('phone_number') is-invalid @enderror" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" name="phone_number" placeholder="Masukan Nomor Telepon" value="{{ old('phone_number') }}">
                                        @error('phone_number')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('city') is-invalid @enderror" name="city" placeholder="Masukan Kota" value="{{ old('city') }}">
                                        @error('city')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('state') is-invalid @enderror" name="state" placeholder="Masukan Negara" value="{{ old('state') }}">
                                        @error('state')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('zip_code') is-invalid @enderror" name="zip_code" placeholder="Masukan Kode Pos" value="{{ old('zip_code') }}">
                                        @error('zip_code')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
