...
@section('content')
    <div class="login-right">
        <div class="login-right-wrap">
            <h1>Mendaftar</h1>
            <p class="account-subtitle">Masukkan detail untuk membuat akun Anda</p>
